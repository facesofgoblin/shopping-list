...
SECRET_KEY = 'django-insecure-sibaetd%*+l#!pqj0^#r^c!ywpa)vmjh01r5z1g!1v=^zq+uf7'
...
INSTALLED_APPS = [
    ...
    'main',
    'authentication', #menambahkan untuk keperluan tutorial 8
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # PERUBAHAN: 13 SEP 2023, TUTORIAL 2 Implementasi Skeleton sebagai Kerangka Views
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#PENAMBAHAN VARIABEL UNTUK KEPERLUAN TUTORIAL 8
